...
Ejecuta únicamente la sincronización y verificación indicadas.

No reconstruyas la funcionalidad.
...
No crees leads reales.

Si la rama feat/quote-preview-frontend-only @ 8fb08fd aparece, cambia a esa rama y verifica los criterios de contenido.

Si no aparece después de git fetch origin --prune, detente y reporta el bloqueo con:
...
- si el commit 8fb08fd existe o no;

- conclusión sobre Git Sync/Lovable mirror.

No ejecutes QA visual todavía hasta que confirmemos que estás exactamente en el commit 8fb08fd.