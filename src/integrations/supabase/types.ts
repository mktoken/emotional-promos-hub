...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      crm_contacts: {
        Row: {
          ...
          preferred_channel: Database["public"]["Enums"]["contact_channel"] | null;
          updated_at: string;
    ...
    Enums: {
      ...
      budget_range: "menos_10000" | "10000_30000" | "30000_75000" | "75000_150000" | "mas_150000" | "por_definir";
      chat_message_role: "visitor" | "assistant" | "system" | "agent";
      client_status: "prospecto" | "activo" | "inactivo" | "perdido" | "recompra_futura";
      client_type:
        | "corporativo"
        | "agencia_marketing"
        | "pyme"
      ...
      deal_stage:
        ...
        | "perdido"
        | "recompra_futura";
      import_batch_status: "pendiente" | "procesando" | "completado" | "parcial" | "fallido";
      lead_source:
        | "cotizacion_web"
        | "whatsapp"
        | "formulario"
